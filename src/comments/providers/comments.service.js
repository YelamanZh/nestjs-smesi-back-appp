...
var CommentsService = function () {
    ...
    var CommentsService = _classThis = /** @class */ (function () {
        function CommentsService_1(commentsRepository, postsRepository) {
            this.commentsRepository = commentsRepository;
            this.postsRepository = postsRepository;
        }
        CommentsService_1.prototype.getByPost = function (postId) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            comments = _a.sent();
                            if (!comments.length) {
                                throw new common_1.NotFoundException('Комментарии для данного поста не найдены.');
                            }
        ...
        CommentsService_1.prototype.createForPost = function (postId, createCommentDto, user) {
            return __awaiter(this, void 0, void 0, function () {
                var post, newComment;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.commentsRepository.save(newComment)];
                    }
                });
            });
        };
