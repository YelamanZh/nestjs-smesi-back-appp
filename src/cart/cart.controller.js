...
var CartController = function () {
    ...
    var CartController = _classThis = /** @class */ (function () {
        ...
        CartController_1.prototype.addToCart = function (user, productId, quantity) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.cartService.addToCart(user, productId, quantity)];
                });
            });
        };
        CartController_1.prototype.removeFromCart = function (user, productId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.cartService.removeFromCart(user, productId)];
                });
            });
        };
        CartController_1.prototype.getCartItems = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.cartService.getCartItems(user)];
                });
            });
        };
    ...
    (function () {
        ...
        _addToCart_decorators = [(0, common_1.Post)('add')];
        _removeFromCart_decorators = [(0, common_1.Delete)('remove/:productId')];
        _getCartItems_decorators = [(0, common_1.Get)('items')];
