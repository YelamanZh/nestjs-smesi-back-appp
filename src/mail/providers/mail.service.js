...
var MailService = function () {
    ...
    var MailService = _classThis = /** @class */ (function () {
        ...
        MailService_1.prototype.sendUserWelcome = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            console.log("Welcome email sent to ".concat(user.email));
                            return [3 /*break*/, 3];
                        case 2:
                            error_1 = _a.sent();
                            console.error("Failed to send welcome email: ".concat(error_1.message));
                            return [3 /*break*/, 3];
