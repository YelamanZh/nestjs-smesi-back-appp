...
var PatchPostDto = function () {
    var _a;
    var _classSuper = (0, swagger_1.PartialType)(create_post_dto_1.CreatePostDto);
    var _id_decorators;
    var _id_initializers = [];
    var _id_extraInitializers = [];
    return _a = /** @class */ (function (_super) {
            __extends(PatchPostDto, _super);
            function PatchPostDto() {
        ...
        (function () {
            ...
            _id_decorators = [(0, swagger_1.ApiProperty)({
                ...
                }), (0, class_validator_1.IsInt)(), (0, class_validator_1.IsNotEmpty)()];
