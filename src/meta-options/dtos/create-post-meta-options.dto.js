...
var CreatePostMetaOptionsDto = function () {
    var _a;
    var _metaValue_decorators;
    var _metaValue_initializers = [];
    var _metaValue_extraInitializers = [];
    return _a = /** @class */ (function () {
            function CreatePostMetaOptionsDto() {
                this.metaValue = __runInitializers(this, _metaValue_initializers, void 0);
                __runInitializers(this, _metaValue_extraInitializers);
            }
            return CreatePostMetaOptionsDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _metaValue_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsJSON)()];
